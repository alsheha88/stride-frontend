...
import { useDeleteConcept } from "../../hooks/concepts/useConcepts";
...
function DeleteConceptModal({
  ...
  const { mutate: deleteConcept, isPending } = useDeleteConcept();
    ...
    >
      ...
      >
        ...
        <p className="text-paragraph text-sm md:text-base">
          ...
          <span className="font-semibold">{conceptName}</span>? This will also
          remove all its ratings, notes, and project links. This action cannot
          be undone.
        </p>
